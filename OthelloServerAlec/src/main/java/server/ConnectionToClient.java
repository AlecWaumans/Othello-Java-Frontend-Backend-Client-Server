...
public class ConnectionToClient extends Thread {
    ...
    /**
     * @author : Alec Waumans (2025) & other author 
     * Alec : i had Closes the client. If the connection is already closed,
    ...
    final public void close() throws IOException {
        ...
        // Alec: Force readObject() to throw an exception to speed up thread termination
        try {
        ...
        // Alec : Explicitly interrupt the thread to immediately stop execution
        this.interrupt();
        // End Alec
    }
